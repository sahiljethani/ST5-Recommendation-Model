...
def parse_args():
    ...
    parser.add_argument('--plm', type=str, default='/exports/eddie/scratch/s2550585/diss/dataset/data/pretrain-item/best_model-pretrain-seq') #st5 model after both pretraining
...
if __name__ == '__main__':
    ...
    # Load the model
    #change the model based on the variant of the model
    #ST5-Final model ->load model after pretraining seq-seq
    #ST5-ItemPre model ->load model after pretraining item-item
    #ST5-NoPre model ->load the base sentence t5 model 
    ...
    #Sequence-Item
    train_dataset=create_dataset(train_df, 'history_text', 'target_item_text')
    eval_dataset=create_dataset(valid_df[:70000], 'history_text', 'target_item_text')
    ...
    model_path = os.path.join(args.output_dir, args.domain, 'seq-item-eddie')
    ...
    # # Save the best model
    best_model_dir = os.path.join(model_path, "best_model-seq-item-eddie")
