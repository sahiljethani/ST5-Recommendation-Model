...
def parse_args():
    ...
    parser.add_argument('--plm', type=str, default='/exports/eddie/scratch/s2550585/diss/dataset/data/pretrain-item/best_model-pretrain-item') #st5 model after pretraining
...
if __name__ == '__main__':
    ...
    #Sequence-Sequenece
    train_dataset=create_dataset(train_df, 'history_text', 'aug_history_text')
    eval_dataset=create_dataset(valid_df[:70000], 'history_text', 'aug_history_text')
    ...
    model_path = os.path.join(args.output_dir, args.domain, 'pretrain-seq')
    ...
    # # Save the best model
    best_model_dir = os.path.join(model_path, "best_model-pretrain-seq")
